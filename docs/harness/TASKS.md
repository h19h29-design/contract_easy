...
- 2026-09-18 REVIEWER 계정 생성: NAS에 admin만 있어 2인 승인이 불가능했던 것을 `scripts/create-user.mjs`로 reviewer(REVIEWER) 생성해 해소. 비밀번호는 `~/agent-hub/secrets/contract_easy-reviewer-password`(600). 로그인 200 확인.
