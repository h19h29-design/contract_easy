...
- 최종 갱신: 2026-09-12
- 최우선: **계약 문서 작성 기능(T-214)**. 작성/자동 채움/다운로드는 미구현이다. Windows의 원클릭 XLSM 원본을 확인했으며 공사표준계약서부터 진행한다. 사용자 확정: **HWPX 필수**. 작성 흐름과 서버 직접 생성 설계를 제안했으며 실제 한글 열기/편집 검증 환경은 미확인이다. 근거: `CONTRACT_FORMS_AUDIT.md`.
